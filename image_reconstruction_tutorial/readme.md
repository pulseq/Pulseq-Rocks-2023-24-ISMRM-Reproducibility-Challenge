...
* Start the Gadgetron software within the container by clicking the Triangle sign below "Actions" in the image above.      
...
### 2.4 Load Gadgetron-reconstructed images
...
## 3. Instructions for vendor-based online reconstruction on Siemens
